...
function getComments($videoid,$nextpage = null){
	...
	$url ='';
	if($nextpage==null){
		$url="https://www.googleapis.com/youtube/v3/commentThreads?key=AIzaSyA3tNT1UJRVvyQkUEl1-zr4oY3Eq3ZQAY0&textFormat=plainText&part=snippet&videoId=" . $videoid."&maxResults=100";
	}else{

		$url="https://www.googleapis.com/youtube/v3/commentThreads?key=AIzaSyA3tNT1UJRVvyQkUEl1-zr4oY3Eq3ZQAY0&textFormat=plainText&part=snippet&videoId=" . $videoid."&maxResults=100&pageToken=".$nextpage;
	}
